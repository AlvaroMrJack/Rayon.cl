...
<!-- Title -->
<title>Rayon.cl próximamente </title>


<!-- CSS Global Compulsory -->
<link rel="stylesheet" href="<?=base_url()?>resources/c_s/css/bootstrap.min.css">
<link rel="stylesheet" href="<?=base_url()?>resources/c_s/css/style.css" >

<!-- CSS Implementing Plugins -->
<link rel="stylesheet" type="text/css" href="<?=base_url()?>resources/c_s/css/font-awesome.min.css" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>resources/c_s/css/ionicons.min.css" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>resources/c_s/css/animate.min.css" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>resources/c_s/css/flexslider.css" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>resources/c_s/css/owl.carousel.css" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>resources/c_s/css/owl.theme.css" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>resources/c_s/css/vegas.min.css" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>resources/c_s/css/menu.css" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>resources/c_s/css/sidebar.css" />
...
<!-- JS -->
<script type="text/javascript" src="<?=base_url()?>resources/c_s/js/modernizr.js"></script>
<script type="text/javascript" src="<?=base_url()?>resources/c_s/js/snap.svg-min.js"></script>
...
<!-- <nav id="menu" class="menu">
	...
	<div class="menu__inner">
		<ul>
			...
			<li>
				<a href="team.html"><i class="fa fa-fw fa-users"></i><span>Team</span></a>
			</li>
			<li>
				<a href="services.html"><i class="fa fa-fw fa-gear"></i><span>Services</span></a>
			</li>
			<li>
				<a href="portfolio.html"><i class="fa fa-fw fa-camera"></i><span>Portfolio</span></a>
			</li>
			<li>
				<a href="contact.html"><i class="fa fa-fw fa-envelope"></i><span>Contact</span></a>
			</li>
		</ul>
	</div>
...
<img class="img-responsive" src="<?=base_url()?>images/d.png" data-at2x="<?=base_url()?>images/d@2x.png" alt="Logo" />
</div>
</header>
<!-- /header -->
...
<!-- JS -->
<script type="text/javascript" src="<?=base_url()?>resources/c_s/js/jquery-1.11.3.min.js"></script>
<script type="text/javascript" src="<?=base_url()?>resources/c_s/js/bootstrap.min.js"></script>
...
<script type="text/javascript" src="<?=base_url()?>resources/c_s/js/trianglify.min.js"></script>
<script type="text/javascript" src="<?=base_url()?>resources/c_s/js/jquery.mb.YTPlayer.js"></script>
<script type="text/javascript" src="<?=base_url()?>resources/c_s/js/jquery.nicescroll.min.js"></script>
<script type="text/javascript" src="<?=base_url()?>resources/c_s/js/jquery.flexslider-min.js"></script>
...
<script type="text/javascript">
  $("#clock-countdown")
  .countdown("2017/09/01", function(event) {
    $(this).text(
